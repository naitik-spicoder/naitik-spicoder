...
A senior year student with majors Physics, chemistry and mathematics
-------------------------------------------------------------

I've been learning about Software and System since when I was in 9th grade. I started with Python and then I learned python till OOPs and then I switched to C# UNITY engine and learned 2D Game development and a bit 3D also and after that I learned GoDot and GDScript and made some projects in that. In 11th class I learned Mechanics So I decided to Simulate the equations in SDL3 C++ and I learned pointers and other important concepts in C++ also and made some projects in it. After 11th final exam i learned Computer Architecture and digital circuits(full adder, selecter, flip-flop, ALU, RAM, ROM(for 7-segmented display), BUS, SAP-4,8) and mathematics of Neural Network (weights, bias, gradient descent, backpropagation, chain rule fot Neural Network)
...
* 🧠  I'm currently learning to train an AI to play a game and opengl for 3d simulations(in VIM)
* 👥  I'm looking to collaborate on projects of simulations and game jams
* 💬  Looking forward to work on ODEs to make simulations of SHM and Dampened oscillation
